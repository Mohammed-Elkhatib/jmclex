        ...
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 md:px-12">
          ...
          >
            ...
            <p className="font-paragraph text-base sm:text-lg md:text-xl text-secondary-foreground max-w-3xl leading-relaxed px-2">
              Connect with tax specialists and structuring experts providing innovative cross-border tax solutions and international business structuring.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 md:px-12">
          ...
          >
            ...
            <div className="space-y-5 md:space-y-6 font-paragraph text-base sm:text-lg text-foreground leading-relaxed">
              <p>
                Our Tax & Structuring network comprises experienced tax professionals, international tax specialists, and business structuring experts. We collaborate on:
              </p>
              <ul className="space-y-2 md:space-y-3 ml-4 md:ml-6">
                <li className="flex items-start gap-3">
                  <span className="text-accent-gold font-bold flex-shrink-0 mt-1">•</span>
                  <span>International tax planning and optimization</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-gold font-bold flex-shrink-0 mt-1">•</span>
                  <span>Cross-border business structuring</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-gold font-bold flex-shrink-0 mt-1">•</span>
                  <span>Transfer pricing and BEPS compliance</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-gold font-bold flex-shrink-0 mt-1">•</span>
                  <span>Tax-efficient entity structuring</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-gold font-bold flex-shrink-0 mt-1">•</span>
                  <span>International tax compliance and reporting</span>
                </li>
              </ul>
            </div>
          </motion.div>
        ...
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 md:px-12">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {[
                { title: 'Tax Planning Projects', desc: 'Develop comprehensive international tax strategies for clients' },
                { title: 'Structuring Advisory', desc: 'Provide expert guidance on optimal business structuring across jurisdictions' },
                { title: 'Tax Compliance', desc: 'Support international tax compliance and reporting requirements' },
                { title: 'Tax Consulting', desc: 'Deliver specialized tax consulting on complex cross-border matters' },
              ].map((item, idx) => (
                <motion.div
                  key={idx}
                  initial={{ opacity: 0, y: 24 }}
        ...
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 md:px-12">
          ...
          >
            ...
            <p className="font-paragraph text-base sm:text-lg text-foreground mb-10 md:mb-12 leading-relaxed px-2 text-center">
              Are you a tax specialist or structuring expert interested in collaborating with JMC LEX? We welcome qualified professionals to submit their profiles.
            </p>
            <TalentNetworkApplicationForm sourcePage="Tax & Structuring" />
          </motion.div>
        </div>
      </section>
