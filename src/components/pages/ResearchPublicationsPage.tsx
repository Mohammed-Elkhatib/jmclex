        ...
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 md:px-12">
          ...
          >
            ...
            <p className="font-paragraph text-base sm:text-lg md:text-xl text-secondary-foreground max-w-3xl leading-relaxed px-2">
              Join our community of leading researchers, academics, and thought leaders contributing to cutting-edge legal and business research initiatives.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 md:px-12">
          ...
          >
            <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl text-foreground mb-6 md:mb-8 leading-tight">
              Advancing Legal and Business Knowledge
            </h2>
            <div className="space-y-5 md:space-y-6 font-paragraph text-base sm:text-lg text-foreground leading-relaxed">
              <p>
                Our Research & Publications network brings together distinguished academics, researchers, and thought leaders dedicated to advancing knowledge in international law, cross-border business, and strategic advisory. We collaborate on:
              </p>
              <ul className="space-y-2 md:space-y-3 ml-4 md:ml-6">
                <li className="flex items-start gap-3">
                  <span className="text-accent-gold font-bold flex-shrink-0 mt-1">•</span>
                  <span>Original legal and business research</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-gold font-bold flex-shrink-0 mt-1">•</span>
                  <span>Peer-reviewed publications and white papers</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-gold font-bold flex-shrink-0 mt-1">•</span>
                  <span>Thought leadership and industry insights</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-gold font-bold flex-shrink-0 mt-1">•</span>
                  <span>Case studies and practical analysis</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent-gold font-bold flex-shrink-0 mt-1">•</span>
                  <span>International regulatory and compliance research</span>
                </li>
              </ul>
            </div>
          </motion.div>
        ...
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 md:px-12">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {[
                { title: 'Research Projects', desc: 'Participate in collaborative research initiatives on emerging legal and business topics' },
                { title: 'Publication Partnerships', desc: 'Co-author articles, reports, and publications with JMC LEX' },
                { title: 'Expert Commentary', desc: 'Contribute expert analysis and commentary on industry developments' },
                { title: 'Speaking Engagements', desc: 'Present research findings and insights at JMC LEX events and forums' },
              ].map((item, idx) => (
                <motion.div
                  key={idx}
                  initial={{ opacity: 0, y: 24 }}
        ...
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 md:px-12">
          ...
          >
            ...
            <p className="font-paragraph text-base sm:text-lg text-foreground mb-10 md:mb-12 leading-relaxed px-2 text-center">
              Are you a researcher or thought leader interested in collaborating with JMC LEX? We invite qualified professionals to submit their profiles and explore partnership opportunities.
            </p>
            <TalentNetworkApplicationForm sourcePage="Research & Publications" />
          </motion.div>
        </div>
      </section>
