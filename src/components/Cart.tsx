        ...
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between p-8 border-b border-foreground/10">
              ...
              <button
                onClick={actions.closeCart}
                className="text-foreground hover:text-accent-gold transition-colors duration-300"
                    ...
                    <div key={item.id} className="bg-background p-6 rounded-lg">
                      <div className="flex gap-6">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-paragraph text-base text-foreground font-medium mb-3 truncate">
                            {item.name}
                          </h3>
                          <p className="font-paragraph text-lg text-accent-gold font-semibold mb-4">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              <button
                                ...
                                className="w-8 h-8 flex items-center justify-center bg-optional-navy text-foreground rounded hover:bg-accent-gold hover:text-secondary-foreground transition-colors duration-300"
                            ...
                            <button
                              ...
                              className="text-foreground/60 hover:text-destructive transition-colors duration-300"
            ...
            {/* Footer */}
            {items.length > 0 && (
              <div className="border-t border-foreground/10 p-8 space-y-6">
                <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="w-full bg-accent-gold text-secondary-foreground font-paragraph font-semibold px-6 py-4 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                  onClick={actions.closeCart}
                  className="w-full bg-transparent text-foreground border border-foreground/20 font-paragraph font-medium px-6 py-3 rounded-lg transition-all duration-300 hover:bg-background"
                >
                  Continue Shopping
                </button>
              </div>
